...
export const AssetCardStory: Story = { name: "AssetCard", render: () => panel(<div className="fortis-storybook-grid"><AssetCard actions={<Button size="sm">Разместить</Button>} meta="Мобильная огневая группа · 3,2 км" selected status="Активен" title="МОГ — пост №1">Совместимо с активным эшелоном.</AssetCard><AssetCard disabled meta="Радиолокационная станция · 18 км" status="Недоступно для L9" title="РЛС «Рубеж»" warning>Выберите эшелон обнаружения.</AssetCard></div>) };
export const EchelonTreeItemStory: Story = { name: "EchelonTreeItem", render: () => panel(<div className="fortis-storybook-grid" role="tree"><EchelonTreeItem count={9} detail="Активный · видим" label="Ближняя зона" level="L2" selected /><EchelonTreeItem color="#936200" count={4} detail="Активный · скрыт" hidden label="Резерв" level="L9" pattern="dashed" warning /></div>) };
