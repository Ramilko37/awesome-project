...
const styles = readFileSync("src/modules/drone-defense/ui/drone-defense-prototype.module.css", "utf8");
...
assert(
  styles.includes("border-right-width: 0") && styles.includes("border-bottom-width: 0"),
...
assert(
  source.includes('data-sidebar-toggle-state={isCatalogTrayOpen ? "hidden" : "visible"}') &&
    ...
    styles.includes("translateX(-0.5rem)"),
